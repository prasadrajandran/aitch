 ...
 */
export const h = (elementHeader, elementDetails, ...nodes) => {
  const {
    style = {},
    attrs = {},
    ...
    ? {}
    : elementDetails || {};
  const elementName = elementHeader.split(' ')[0];
  const el = namespaceUri
    ? document.createElementNS(namespaceUri, elementName, elementOptions)
    : document.createElement(elementName, elementOptions);
